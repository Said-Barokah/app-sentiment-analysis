...
def app():
    ...
    list_stem_stop_leng = ['arabic', 'danish', 'dutch', 'english', 'finnish', 'french', 'german', 'hungarian', 'italian', 'indonesian','norwegian', 'portuguese', 'romanian', 'russian', 'spanish', 'swedish']
    ...
    if steps == "remove stopwords":
        text_preprocessing(data,'remove stopwords',column,list_stem_stop_leng,index_detect_leng)
    if steps == 'stemming' :
